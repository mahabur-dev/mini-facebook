const exploreItems = [
  ...
  },
  {
    ...
    href: "#0",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#666" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="feather feather-settings">
        <circle cx="12" cy="12" r="3" />
        <path d="M19.4 15a1.7 1.7 0 0 0 .33 1.87l.06.06a2 2 0 0 1-1.41 3.41h-.06a2 2 0 0 1-1.87-.33 1.7 1.7 0 0 0-1.82 0 1.7 1.7 0 0 0-.8 1.47V22a2 2 0 0 1-2 2 2 2 0 0 1-2-2v-.06a1.7 1.7 0 0 0-1-.8 1.7 1.7 0 0 0-1.82 0 1.7 1.7 0 0 0-.8 1.47V22a2 2 0 0 1-2 2 2 2 0 0 1-2-2v-.06a2 2 0 0 1-.33-1.87 1.7 1.7 0 0 0 0-1.82 1.7 1.7 0 0 0-1.47-.8H2a2 2 0 0 1-2-2 2 2 0 0 1 2-2h.06a1.7 1.7 0 0 0 1.47-.8 1.7 1.7 0 0 0 0-1.82 1.7 1.7 0 0 0-1.47-.8H2a2 2 0 0 1-2-2 2 2 0 0 1 2-2h.06a1.7 1.7 0 0 0 1.87-.33 1.7 1.7 0 0 0 .8-1.47V2a2 2 0 0 1 2-2 2 2 0 0 1 2 2v.06a1.7 1.7 0 0 0 1 .8 1.7 1.7 0 0 0 1.82 0 1.7 1.7 0 0 0 .8-1.47V2a2 2 0 0 1 2-2 2 2 0 0 1 2 2v.06a2 2 0 0 1 .33 1.87 1.7 1.7 0 0 0 0 1.82 1.7 1.7 0 0 0 1.47.8H22a2 2 0 0 1 2 2 2 2 0 0 1-2 2h-.06a1.7 1.7 0 0 0-1.47.8z" />
      </svg>
    ),
  },
  {
        ...
        <div className="_left_inner_area_explore _padd_t24 _padd_b6 _padd_r24 _padd_l24 _b_radious6 _feed_inner_area">
          ...
          <ul className="_left_inner_area_explore_list">
            {exploreItems.map((item) => (
              <li key={item.label} className={`_left_inner_area_explore_item${item.featured ? " _explore_item" : ""}`}>
                <a href={item.href} className="_left_inner_area_explore_link">
                  {item.icon}
                  {item.label}
                </a>
                {item.featured ? <span className="_left_inner_area_explore_link_txt">New</span> : null}
              </li>
            ))}
          </ul>
        </div>
            ...
            <div className="_left_inner_area_suggest_info" key={person.name}>
              <div className="_left_inner_area_suggest_info_box">
                <div className="_left_inner_area_suggest_info_image">
                  <a href="/profile.html">
                    <img src={person.image} alt="Image" className={index === 0 ? "_info_img" : "_info_img1"} />
                  </a>
                </div>
            ...
            <a key={event.id} className="_left_inner_event_card_link" href="event-single.html">
              <div className="_left_inner_event_card">
                ...
                <div className="_left_inner_event_bottom">
                  ...
                  <span className="_left_iner_event_bottom_link" role="button" tabIndex={0}>
                    Going
                  </span>
                </div>
              </div>
