      ...
      <div className="container _custom_container">
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <ul className="navbar-nav mb-2 mb-lg-0 _header_nav_list ms-auto _mar_r8">
            ...
            <li className="nav-item _header_nav_item">
              <span className="nav-link _header_nav_link _header_notify_btn" role="button" tabIndex={0} onClick={toggleNotifications} onKeyDown={(event) => event.key === "Enter" && toggleNotifications()}>
                ...
                <div id="_notify_drop" className={cn("_notification_dropdown", notificationsOpen && "show")}>
                  <div className="_notifications_content">
                    ...
                    <div className="_notification_box_right">
                      <button type="button" className="_notification_box_right_link" onClick={() => setNotificationActionsOpen((value) => !value)}>
                      ...
                      <div className={cn("_notifications_drop_right", notificationActionsOpen && "show")}>
